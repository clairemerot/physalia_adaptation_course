...
#### Step 0 Prepare data on the server

RDA takes a matrix of genotypes (0,1,2) that we know how to obtain (we did yesterday)

vcftools --vcf 02_data/populations_can_random.vcf --012 --out 06_rda/populations_can_random
