...
```
F<sub>ST</sub> for each locus is at the 8<sup>th</sup> column. We can look at the 20 most differentiated SNPs.
```
grep -v "^#" populations.fst_L-K.tsv | sort -rk8,8 | head -n 
```
