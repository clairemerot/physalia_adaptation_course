...
### Step 0: copy basic files
First you need to move within the folder ``04_day4/02-CNVs/``. To make it easier, I added all required basic files:
* 00-scripts, you will find all the scripts that we will use to extract CNVs info. Note that all these scripts came from the [stacks_workflow](https://github.com/enormandeau/stacks_workflow) developed by Eric Normandeau.
